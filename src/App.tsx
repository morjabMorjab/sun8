      ...
      <div className="flex flex-col pb-6">
        {["dental", "consumable", "diagnostic", "operating_room", "traditional"].map((cat) => (
          <div key={cat} className="flex flex-col gap-1.5 mt-[10px]">
            <div className="flex justify-between items-center px-3 py-1.5 bg-gray-300 border border-gray-400 rounded-[2px] ml-[5px] mr-[3px]">
              ...
              <button 
                ...
                className="text-[10px] font-bold text-indigo-800 hover:text-indigo-950 transition-colors"
              >
                مشاهده همه &gt;
              </button>
            </div>
